// Désactivé : composant Timer (démarrer/pause sur une tâche)
//
// /**
...
//
//   return (
//     <span style={{ fontFamily: 'var(--font-mono)', fontSize: '2rem', fontWeight: 500, color: 'var(--color-accent)', letterSpacing: '0.02em' }}>
//       {formatDuration(elapsed)}
//     </span>
//   )
// }

export {} // garde le fichier comme module TypeScript valide
